<?php
include("./cnx/cnx-web.php");
$estados = array();

$estados[] = array('nombre'=>'Aguascalientes','municipios'=>array(
...
$estados[] = array('nombre'=>'Baja California','municipios'=>array(
...
$estados[] = array('nombre'=>'Baja California Sur','municipios'=>array(
...
$estados[] = array('nombre'=>'Campeche','municipios'=>array(
...
$estados[] = array('nombre'=>'Chiapas','municipios'=>array(
...
$estados[] = array('nombre'=>'Chihuahua','municipios'=>array(
...
$estados[] = array('nombre'=>'Ciudad de México','municipios'=>array(
...
$estados[] = array('nombre'=>'Coahuila','municipios'=>array(
...
$estados[] = array('nombre'=>'Colima','municipios'=>array(
...
$estados[] = array('nombre'=>'Durango','municipios'=>array(
...
$estados[] = array('nombre'=>'Guanajuato','municipios'=>array(
...
$estados[] = array('nombre'=>'Guerrero','municipios'=>array(
...
$estados[] = array('nombre'=>'Hidalgo','municipios'=>array(
...
$estados[] = array('nombre'=>'Jalisco','municipios'=>array(
...
$estados[] = array('nombre'=>'México','municipios'=>array(
...
$estados[] = array('nombre'=>'Michoacán','municipios'=>array(
...
$estados[] = array('nombre'=>'Morelos','municipios'=>array(
...
$estados[] = array('nombre'=>'Nayarit','municipios'=>array(
...
$estados[] = array('nombre'=>'Nuevo León','municipios'=>array(
...
$estados[] = array('nombre'=>'Oaxaca','municipios'=>array(
...
'Guelatao de Juárez',
'Guevea de Humboldt',
'Heróica Ciudad de Ejutla de Crespo',
'Heróica Ciudad de Huajuapan de León',
'Heróica Ciudad de Tlaxiaco',
'Huautepec',
'Huautla de Jiménez',
'Ixpantepec Nieves',
'Ixtlán de Juárez',
...
$estados[] = array('nombre'=>'Puebla','municipios'=>array(
...
$estados[] = array('nombre'=>'Querétaro','municipios'=>array(
...
$estados[] = array('nombre'=>'Quintana Roo','municipios'=>array(
...
$estados[] = array('nombre'=>'San Luis Potosí','municipios'=>array(
...
$estados[] = array('nombre'=>'Sinaloa','municipios'=>array(
...
$estados[] = array('nombre'=>'Sonora','municipios'=>array(
...
$estados[] = array('nombre'=>'Tabasco','municipios'=>array(
...
$estados[] = array('nombre'=>'Tamaulipas','municipios'=>array(
...
$estados[] = array('nombre'=>'Tlaxcala','municipios'=>array(
...
$estados[] = array('nombre'=>'Veracruz','municipios'=>array(
...
$estados[] = array('nombre'=>'Yucatán','municipios'=>array(
...
$estados[] = array('nombre'=>'Zacatecas','municipios'=>array(
...
mysql_query("TRUNCATE CatMunicipios");
...
for($i=0;$i<sizeof($estados);$i++)
{
    ...
    $insert = "INSERT INTO CatEstados(tCodEstado,tNombre) VALUES ('3','".$estados[$i]['nombre']."')";
    print $insert.'<br>';
    $rs = mysql_query($insert);
    print $rs ? 'OK<br>' : mysql_error($rs);
    print '<br><br>';
    
    
    foreach($estados[$i]['municipios'] as $municipio)
    {
        $insert2 = "INSERT INTO CatMunicipios(eCodEstado,tNombre) VALUES ($b,'".$municipio."')";
        print $insert2.'<br>';
        mysql_query($insert2);
